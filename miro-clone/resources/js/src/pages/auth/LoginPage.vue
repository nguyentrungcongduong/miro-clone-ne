...
// Check if there's an error in the URL query
onMounted(() => {
        ...
        <div class="w-full max-w-md">
            ...
            <div class="bg-white rounded-xl shadow-xl overflow-hidden border border-slate-200">
                ...
                <div class="bg-blue-600 p-6 text-center">
                    <h1 class="text-2xl font-bold text-white">Welcome to Miro Clone</h1>
                    <p class="text-blue-100 mt-1">Sign in to start collaborating</p>
                </div>
                ...
                <div class="p-8">
                    ...
                    <button
                        ...
                        :disabled="isLoading"
                        class="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white border border-slate-200 rounded-lg shadow-sm hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors"
                    >
