// import { ref } from "vue";
// import { __debounce } from "../../../../../helper/util.ts";
...
// import {textCaptionStore} from "../../../../../store/textCaption.ts";
...
export function useDragTextCaption() {
    ...
    function dragTextCaption(id: number) {
        ...
        //dragging
        textCaptionHandler.addEventListener("mousedown", function (e: MouseEvent) {
            textCaptionStore.textCaption.id = id;
