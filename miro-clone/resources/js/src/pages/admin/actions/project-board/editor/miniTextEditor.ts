...
// import {__debounce, runFuncSequentially} from "../../../../../helper/util.ts";
...
// import {IMiniTextEditor} from "./miniTextEditorTypes.ts";
...
export function useDragMiniTextEditor() {
    ...
    let miniTextEditorStartHeight = 0;
    ...
    function setCursorInsideElement(
        ...
        for (let i = 0; i < element.childNodes.length; i++) {
            ...
            const length = (child.textContent as string).length;
    ...
    function changeMiniTextEditorBodyContent(id: number) {
        ...
        function _changeMiniTextEditorContentOnKeyDownOrOnMouseUpEvent() {
            ...
            const cursorData = getCursorPosition(miniTextEditorContent, blinkingCursor);

            if (cursorData) {
                const { cursorPosition, x, y } = cursorData;
            ...
            function _changeMiniTextEditorContent(): void {
            ...
            const func1 = (): Promise<null> => {
                return new Promise((resolve) => {
                    // cursorPosition is already set in yDocStore.cursor from the event handler
                    _changeMiniTextEditorContent();
                    resolve(null);
                });
            };

            const func2 = (): Promise<null> => {
                return new Promise((resolve) => {
    ...
    function dragMiniTextEditor(id: number) {
        ...
        miniTextEditorResizer.addEventListener(
            ...
            function (e: MouseEvent) {
                ...
                function mouseMove(e: MouseEvent) {
                    ...
                    miniTextEditor.style.height =
                        Math.max(newHeight, 100) + "px";
                }
        ...
        //dragging
        miniTextEditorHandler.addEventListener("mousedown", function (e: MouseEvent) {
            miniTextEditorStore.miniTextEditor.id = id;
