...
import {IStickyNote} from "@/pages/admin/actions/project-board/stickynote/stickeyNoteTypes";
// import {IStickyNote} from "./stickeyNoteTypes.ts";
...
export function useDragStickyNote() {
    ...
    function dragStickyNote(id: number) {
        ...
        //resizing
        stickyNoteResizer.addEventListener("mousedown", function (e: MouseEvent) {
        ...
        //dragging
        stickyNoteHandler.addEventListener("mousedown", function (e: MouseEvent) {
            stickyNoteStore.stickyNote.id = id;
