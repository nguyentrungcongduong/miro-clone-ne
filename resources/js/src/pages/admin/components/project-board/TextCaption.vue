...
<template>
    ...
    >
        ...
        <div
            :class="
                'card-body w-full bg-white h-full border-none outline-none p-2 font-bold text-caption-body-' + textCaption.id
            "
        ...
        <div class="flex justify-end">
            <div
                :class="'cursor-nw-resize text-caption-resizer-' + textCaption.id"
            >
                <ArrowDownIcon />
            </div>
        </div>
